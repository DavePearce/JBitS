package jbits.layouts;

import static jbits.layouts.Primitive.*;

import java.util.function.BiFunction;

import jbits.core.Content;
import jbits.core.Content.Blob;
import jbits.core.Content.Constructor;
import jbits.util.AbstractLayout;
import jbits.util.AbstractProxy;
